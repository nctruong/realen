...
class PhrasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phrase" do
    assert_difference('Phrase.count') do
      post phrases_url, params: { phrase: { comment: @phrase.comment, content: @phrase.content } }
    end
  ...
  test "should update phrase" do
    patch phrase_url(@phrase), params: { phrase: { comment: @phrase.comment, content: @phrase.content } }
