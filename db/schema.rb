...
ActiveRecord::Schema.define(version: 20161002091455) do
  ...
  create_table "phrases", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "updated_at",       null: false
    t.string   "audio"
    t.string   "phonetic_symbols"
    t.index ["sentence_id"], name: "index_phrases_on_sentence_id", using: :btree
  end
  ...
  create_table "sections", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["lession_id"], name: "index_sections_on_lession_id", using: :btree
  end
  ...
  create_table "sentences", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "updated_at", null: false
    t.string   "audio"
    t.index ["section_id"], name: "index_sentences_on_section_id", using: :btree
  end
